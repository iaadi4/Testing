      ...
      case "updateSettings": {
        const updated = await prisma.siteSetting.update({
          ...
          data: {
            ...
            weekPrice: data.weekPrice !== undefined ? Math.max(1, Number(data.weekPrice)) : settings?.weekPrice,
            monthPrice: data.monthPrice !== undefined ? Math.max(1, Number(data.monthPrice)) : settings?.monthPrice,
            yearPrice: data.yearPrice !== undefined ? Math.max(1, Number(data.yearPrice)) : settings?.yearPrice,
            lifetimePrice: data.lifetimePrice !== undefined ? Math.max(1, Number(data.lifetimePrice)) : settings?.lifetimePrice,
